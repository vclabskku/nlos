...
//typedef unsigned char BYTE; ///< Define BYTE type used in some buffer operations
typedef unsigned char uint8; ///< 8 bit unsigned integer

typedef unsigned int Sym_t; ///< Symbol type used by variable system functions
